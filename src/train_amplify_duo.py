...
def load_base_model():
    ...
    # Sprawdź, czy modele zostały załadowane
    print("[CHECK] out_model:", out_model)

    # Wypisz szczegóły pierwszego modelu
    print("[CHECK] out_model[0]:")
    out_model[0].summary()
...
def build_duo_model():
    ...
    """
    #inputs_right = Input(shape=(MAX_LEN, 20), name='Input_activity_union')
    #inputs_left = Input(shape=(MAX_LEN, 20), name='Input_toxicity_union')

    inputs_combined = Input(shape=(MAX_LEN, 20), name='Input_duo')
